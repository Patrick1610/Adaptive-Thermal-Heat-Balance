    ...
    def _context_attributes(self) -> dict[str, Any]:
        ...
        attributes: dict[str, Any] = {
            ...
            "related_values": {
                ...
                "comfort_range_lower_limit": values.get("lower_comfort_boundary"),
                "heating_control_point": values.get("heating_control_target"),
                "comfort_range_neutral_reference": values.get("thermal_neutral"),
                "cooling_control_point": values.get("cooling_control_target"),
                "comfort_range_upper_limit": values.get("upper_comfort_boundary"),
