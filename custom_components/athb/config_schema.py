...
def validate_options(data: Mapping[str, Any]) -> dict[str, str]:
    ...
    ranges = {
        ...
        "stale_heat_active_minutes": (15.0, 60.0),
        "stale_heat_start_minutes": (30.0, 60.0),
        "stale_heat_ramp_minutes_per_c": (5.0, 15.0),
        "stale_heat_ramp_max_minutes": (15.0, 60.0),
        "relative_humidity_freshness_minutes": (5.0, 360.0),
        "local_temperature_freshness_minutes": (5.0, 360.0),
        "radiant_freshness_minutes": (5.0, 360.0),
        "air_speed_freshness_minutes": (5.0, 360.0),
