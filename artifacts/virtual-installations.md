...
- Comfort/occupancy/Boost: `efficient` / `absent` / `off`; fallback: `False`
...
- Comfort/occupancy/Boost: `comfort` / `absent` / `off`; fallback: `False`
...
## VI-019 — Automatically inferred auto range
